...
**problem**: jointly maximized the likelihood of the word **and the observed visual features** given the previous words and their visual interpretations (hiddeng states). (section 3)
